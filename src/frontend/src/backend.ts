...
import type { UserRole as _UserRole, VideoStatus as _VideoStatus, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addVideo(arg0: string, arg1: string, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addVideo(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAdminDashboard(): Promise<[Array<string>, Array<string>]> {
        if (this.processError) {
            try {
    ...
    async getAllVideoEngagements(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllVideoEngagements(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllVideos(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getCallerUserProfile(): Promise<string | null> {
        if (this.processError) {
            try {
    ...
    async getUserVideoStatus(arg0: Principal, arg1: string): Promise<VideoStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserVideoStatus(arg0, arg1);
                return from_candid_VideoStatus_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getUsersWithoutResponse(arg0: string): Promise<Array<Principal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUsersWithoutResponse(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVideo(arg0: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async saveCallerUserProfile(): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setUserVideoStatus(arg0: string, arg1: VideoStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setUserVideoStatus(arg0, to_candid_VideoStatus_n15(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "watched" in value ? VideoStatus.watched : "noResponse" in value ? VideoStatus.noResponse : "notInterested" in value ? VideoStatus.notInterested : "watchLater" in value ? VideoStatus.watchLater : value;
}
function to_candid_UserRole_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserRole): _UserRole {
    return to_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function to_candid_VideoStatus_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VideoStatus): _VideoStatus {
...
function to_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VideoStatus): {
    watched: null;
} | {
    noResponse: null;
} | {
    ...
    return value == VideoStatus.watched ? {
        watched: null
    } : value == VideoStatus.noResponse ? {
        noResponse: null
    } : value == VideoStatus.notInterested ? {
        notInterested: null
    } : value == VideoStatus.watchLater ? {
        watchLater: null
    } : value;
}
